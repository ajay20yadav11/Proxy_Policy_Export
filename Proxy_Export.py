...
for line in new_line:
    ...
    if (
        ...
        url_with_both_url_name_url[
            line["prox_acl_custom_category_name"]
        ] = line["prox_acl_custom_category_servers"][
            "prox_acl_custom_category_server"
        ]
        url_with_both_url_name_regex[
            line["prox_acl_custom_category_name"]
        ] = line["prox_acl_custom_category_regex_list"][
...
full_border = copy_to_workbook.add_format({
    'border': 1
...
outsheet2 = copy_to_workbook.add_worksheet(
    name="URL Categories with URL allowed"
)
